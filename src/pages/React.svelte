  ...
  <section>
    ...
    <div class="metric-chart-container">
      <MetricChart
        ...
        fastTooltip="{data[selectedOption].firstContentfulPaintCrux.data[0]}% of loads for these origins have a fast (< 1 s) FCP."
        averageTooltip="{data[selectedOption].firstContentfulPaintCrux.data[1]}% of loads for these origins have an average (1 s ~
        2.5 s) FCP."
        slowTooltip="{data[selectedOption].firstContentfulPaintCrux.data[2]}% of loads for these origins have a slow (> 2.5 s) FCP." />
    </div>
  ...
  <section>
    ...
    <div class="metric-chart-container">
      <MetricChart
        ...
        fastTooltip="{data[selectedOption].firstInputDelayCrux.data[0]}% of loads for these origins have a fast (< 50 ms) FID."
        averageTooltip="{data[selectedOption].firstInputDelayCrux.data[1]}% of loads for these origins have an average (50 ms ~
        250 ms) FID."
        slowTooltip="{data[selectedOption].firstInputDelayCrux.data[2]}% of loads for these origins have a slow (> 250 ms) FID." />
    </div>
